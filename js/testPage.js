...
question.innerText = `${qnaArr[0].question}`;
firstAnswer.innerText = `${qnaArr[0].answerOne}`;
secondAnswer.innerText = `${qnaArr[0].answerTwo}`;

const firstBtn = document.querySelector('.first');
const secondBtn = document.querySelector('.second');

function goOne() {
    question.innerText = `${qnaArr[1].question}`
}

firstBtn.addEventListener('click', goOne);
secondBtn .addEventListener('click', goTwo);